  ...
  return (
    <div id="About">
      ...
      <div className="Portfolio_aboutMe-content">
        ...
        expertise in web development. With a background in Electronics and
        Communication Engineering, I bring a unique perspective to coding,
        ...
        tech and expanding my skills to tackle new challenges. Let’s connect and
